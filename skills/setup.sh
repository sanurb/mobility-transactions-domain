#!/bin/bash
# Setup AI Skills for this repo. Canonical skills live in skills/ (this directory).
...
show_help() {
    ...
    echo ""
    echo "Configure AI coding assistants for Mobility Transactions development."
    echo ""
    echo "Options:"
...
echo "🤖 Mobility Transactions AI Skills Setup"
echo "=========================="
echo ""
